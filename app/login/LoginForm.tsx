      ...
      <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative my-6 flex items-center justify-center">
            ...
            <span className="relative bg-white px-3 text-xs text-zinc-400 uppercase">
              O continuar con
            </span>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-300 bg-white px-3 py-2.5 text-sm font-medium text-zinc-700 hover:bg-zinc-50 outline-none transition-colors disabled:opacity-60"
          >
